...
#' @export
#'
download.annovar.db <- function(force=FALSE, path_to_annovar=NA, path_annovar_db="DB_annovar"){
...
#' @export
#'
vcf.annovar.annotation <- function(my_raw_vcf, path_results="MORFEE_results", path_to_annovar=NA, path_annovar_db="DB_annovar"){
